...
<nav class="navbar navbar-expand-custom navbar-mainbg">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a href="menu_usuarios.php"><i class="fas fa-home"></i>Usuarios</a>
      </li>
      
      <li class="nav-item">
        <a href="menu_maestros.php"><i class="fas fa-exclamation-triangle"></i>Maestros</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="menu_alumnos.php"><i class="fas fa-certificate"></i>Alumnos</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="menu_usuario.php"><i class="fas fa-certificate"></i>Acciones</a>
      </li>
